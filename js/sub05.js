window.addEventListener('DOMContentLoaded', function () {
    ...
    sc02.to(".se02_img02",{opacity:1,x:0},0.5);
    sc02.to(".se02_img02_text img",{opacity:1,y:0},1.5);
    sc02.to(".se02_img02_ui",{opacity:1,y:0},0);

    sc02.to(".se02_img03_deco",{opacity:1,y:0},3);
    sc02.to(".se02_img03",{opacity:1,x:0},3.8);
    sc02.to(".se02_img03_text img",{opacity:1,y:0},4.2);
    sc02.to(".se02_img03_ui",{opacity:1,y:0},4);

    sc02.to(".se02_img04",{opacity:1,x:0},4.5);
    sc02.to(".se02_img04_text img",{opacity:1,y:0},4.0);
    sc02.to(".se02_img04_ui",{opacity:1,y:0},4.5);
